...
namespace parameters {
    ...
    const Eigen::Translation3d TranslationGimbalToCamera{Eigen::Vector3d{100, 0, 100} / 1000.0};
    const Eigen::Translation3d TranslationGimbalToMuzzle{Eigen::Vector3d{25, 0, 0} / 1000.0};
    const Eigen::Translation3d TranslationGimbalToTransmitter{Eigen::Vector3d{0, 0, 0} / 1000.0};
    ...
    const double AverageBulletSpeed30 = 27.0;
    const double AverageBulletSpeed18 = 15.6;
    const double AverageBulletSpeed15 = 12.2;

    const double StaticYawOffset = 1.4 / 180.0 * parameters::Pi;
    const double StaticPitchOffset = 1.8 / 180.0 * parameters::Pi;
}